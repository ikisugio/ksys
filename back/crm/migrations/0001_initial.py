    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_user', models.CharField(blank=True, max_length=255, null=True)),
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='jigyosyos', to='crm.company')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jigyosyo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='transactions', to='crm.jigyosyo')),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
